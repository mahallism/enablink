			...
			<div class="col-md-3">
				<div class="card mb-3 border-danger">
					<div class="card-body py-3 bg-danger text-white">
						...
						<h5 class="card-title h2 mt-1"><?php echo $data_count['surat_izin']; ?></h5>
			...
			<div class="col-md-4">
				<div class="card mb-3 border-info">
					<div class="card-body py-3 bg-info text-white">
						...
						<h5 class="card-title h2 mb-1"><?php echo $data_count['mahasiswa_difabel']; ?></h5>
			...
			<div class="col-md-4">
				<div class="card mb-3 border-info">
					<div class="card-body py-3 bg-info text-white">
						...
						<h5 class="card-title h2 mb-1"><?php echo $data_count['mahasiswa_volunteer']; ?></h5>
			...
			<div class="col-md-4">
				<div class="card mb-3 border-info">
					<div class="card-body py-3 bg-info text-white">
						...
						<h5 class="card-title h2 mb-1"><?php echo $data_count['mahasiswa_register']; ?></h5>
