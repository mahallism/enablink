...
class Fakultas extends App_Controller {
	...
	protected $list_field  	= array(
		'field' 	=> array(
			...
			'majors_name' 	=> 'Nama Prodi',
            'majors_focus' 	=> 'Fokus Prodi',
            'level' 	    => 'Jenjang',
		),
		'custom' 	=> array(
			'majors_name' 	=> '$item["majors_id"] === null ? "-" : $item["level"] . " - " . $item["majors_name"]',
            'majors_focus' 	=> '$item["majors_focus"] === null ? "-" : $item["majors_focus"]',
		),
	);
