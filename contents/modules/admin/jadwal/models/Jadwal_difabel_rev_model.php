...
class Jadwal_difabel_rev_model extends Aplego_Model {
	public $table_name 			= "app_schedule_student_rev";
	public $primary_key 		= "schedule_student_rev_id";
	protected $table_view_name 	= 'app_schedule_student_rev_view';
