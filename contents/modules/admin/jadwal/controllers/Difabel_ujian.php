...
class Difabel_ujian extends App_Controller {
    protected $module_main = 'jadwal/difabel_ujian';
    protected $module_name = 'jadwal kuliah/ujian madif';
...
//    protected $gets_view 	= true;
    ...
    {
        $this->filter();
        $this->model->where('date IS NOT NULL');
		...
		$this->param['jadwal_ujian_url'] = $this->group . "pendampingan";
        parent::index($id);
    }
    ...
    public function detail($id = false)
    {
        ...
        $this->title = 'Jadwal Kegiatan/Ujian Mahasiswa';
        $this->param['size'] = 'md';
