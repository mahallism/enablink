...
<body class="sticky-top"
 ...
 max-width: 100%">
                    ...
                    <div class="bg-white p-3" style="max-height:270px">
                        <div class="row">
                            ...
                            <div class="col-sm-10 mt-3">
                                ...
                                <p class="small font-weight-lighter">Rumah Layanan Disabilitas Universitas Brawijaya</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="text-right col-sm-2 mt-3">
                            ...
                            <div class="col-sm-10 mt-3">
                                <h5 class="small">Mobile:</h5>
                                <p class="small font-weight-lighter">+62 811-3030-626</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="text-right col-sm-2 mt-3">
                            ...
                            <div class="col-sm-10 mt-3">
                                ...
                                <p class="small font-weight-lighter">psldbrawijaya@ub.ac.id</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-sm text-left">
      ...
      <p class="pt-3 font-weight-lighter">Copyright © <?php echo date("Y"); ?> enablink</p>
    </div>
