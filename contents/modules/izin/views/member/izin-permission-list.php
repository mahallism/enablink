						...
						<tr>
							...
							<?php if (isset($action_url['duplicate']) || isset($action_url['edit']) || isset($action_url['delete'])): ?>
								<td class="text-center text-nowrap">
									...
									<?php endif ?>
									<?php if (isset($action_url['edit']) && isset($action_url['edit']['id']) && $item[$action_url['edit']['id']] !== null && $item['status']!='diterima'): ?> &nbsp;
									...
									<?php if (isset($action_url['delete']['url'])): ?>
										<?php if (($id !== $can_delete_first) && protected_item($user_group[$action_url['delete']['protection']]) && isset($action_url['delete']['id']) && $item[$action_url['delete']['id']] !== null && $item['status']!='diterima'): ?> &nbsp;
