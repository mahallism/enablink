<div class="content max-<?php echo $size; ?>-container">
	...
	<div class="content-body">
		<div class="card">
			...
			<table class="table table-responsive table-sm table-striped table-hover mb-0" datatables="">
				<thead>
					<tr>
								...
								<td class="text-center text-nowrap">
									...
									<?php if (isset($action_url['delete']['url'])): ?>
										<?php if (($id !== $can_delete_first) && protected_item($user_group[$action_url['delete']['protection']]) && isset($action_url['delete']['id']) && $item[$action_url['delete']['id']] !== null): ?> &nbsp;
											<a href="<?php echo $action_url['delete']['url'] . '/' . (isset($action_url['delete']['id'])? $item[$action_url['delete']['id']]: $id); ?>" onclick="return confirm('Menghapus data semester akan berdampak hilangnya seluruh data (jadwal pendampingan, jadwal mahasiswa, riwayat pendampingan, izin, mahasiswa aktif). Proses tidak dapat dikembalikan. Apakah anda yakin akan menghapus data?')" class="text-danger"><i class="fa fa-trash"></i></a>
										<?php endif; ?>
									<?php endif ?>
								</td>
							<?php endif ?>
