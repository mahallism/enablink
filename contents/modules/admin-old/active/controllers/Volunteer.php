	...
	public function approve($id = false)
	{
		...
		if (!$data) {
            ...
            if(!empty($data['rev_at'])) {
                ...
                if($data['rev'] == "0"){
                    $this->jadwal_volunteer_model->backup_jadwal_active_student(array(
                        "student_id"=>$data['student_id'],
                        "semester_id"=>$data['semester_id']
                    ));
                }
                $this->jadwal_volunteer_model->softdelete_jadwal_active_student(array(
                    "student_id"=>$data['student_id'],
                    "semester_id"=>$data['semester_id']
                ));
                $this->jadwal_volunteer_model->set_jadwal_rev_active_student(array(
                    "student_id"=>$data['student_id'],
                    "semester_id"=>$data['semester_id'],
                    "rev"=>$data['rev'] + 1
                ));
